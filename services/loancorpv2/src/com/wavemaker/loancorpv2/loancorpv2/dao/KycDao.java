...
/**
 * Specifies methods used to obtain and modify Kyc related information
 * which is stored in the database.
 */
@Repository("loancorpv2.KycDao")
public class KycDao extends WMGenericDaoImpl<Kyc, Integer> {
